...
@section('content')
    <main class="bg-blue-50 bg-fixed bg-cover h-screen overflow-auto">
        ...
        <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="{{route('home')}}" class="flex items-center p-2 rounded-lg dark:text-white hover:text-blue-600 hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="w-6 h-6 hover:text-blue-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="sm:ml-64 overflow-scroll h-screen backdrop-blur-2xl">
            @yield('main-content')
        </div>
    </main>
