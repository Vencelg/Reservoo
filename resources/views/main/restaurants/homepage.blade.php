...
@section('main-content')
    <div class="pt-4 w-[80%] m-auto">
        <div class="w-full bg-blue-600 p-5 rounded-2xl mb-5 flex justify-between items-end">
            <div class="flex w-2/3 mr-5">
                <div class="w-full">
        ...
        <div id="restaurantList" class="grid grid-cols-3 gap-5 justify-items-center">
